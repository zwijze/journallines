 ...
 * <pre>
 * &lt;xs:complexType xmlns:ns="http://www.opentravel.org/OTA/2003/05" xmlns:xs="http://www.w3.org/2001/XMLSchema" name="InsurancePrefType">
 *   &lt;xs:simpleContent>
...
public class InsurancePrefType
{
    ...
    /** 
     * Get the 'RPH' attribute value. Index number to be used for reference the insurance policy to be used in this travel collection.
     * 
     * @return value
     */
    ...
    /** 
     * Set the 'RPH' attribute value. Index number to be used for reference the insurance policy to be used in this travel collection.
     * 
     * @param RPH
     */
